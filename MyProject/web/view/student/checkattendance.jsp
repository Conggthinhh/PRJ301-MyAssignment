<%-- 
    ...
    Created on : Oct 24, 2022, 5:28:10 PM
    Author     : Mr Thinh
--%>
        ...
        <div class="container-fluid">
            ...
            <div class="row header">
                ...
                <div class="name-title" style="padding-top: 40px; font-weight: bold;">
                    <p style="font-size: 30px; text-align: center;">Attendance for IOT1601(Slot 1)</p>
                </div>
                    ...
                    <c:if test="${requestScope.students ne null}">
                        <table style="width: 100%; padding-right: 20px;">
                            <thead style="background-color: aquamarine;  height: 100px;">
                                <tr>
                                    <th style="border-right: 1px solid white; padding: auto;">IMAGE</th>
                                    <th style="border-right: 1px solid white; padding: auto;">MEMBER</th>
                                    <th style="border-right: 1px solid white; padding: auto;">CODE</th>
                                    <th style="border-right: 1px solid white; padding: auto;">ATTENDED</th>
                                    <th style="border-right: 1px solid white; padding: auto;">ABSENT</th>   
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="border-top: 1px solid black; padding: auto;"><input type="radio" value="check" name="checkattendance"></td>
                                    <td style="border-top: 1px solid black; padding: auto;"><input type="radio" value="check" name="checkattendance"></td>
                                </tr>
                                </c:forEach>
                            </tbody>
